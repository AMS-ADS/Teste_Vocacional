...
<div class="form-container">
    <div class="form-field" :class="{'form-field--prefix-icon': prefixIcon !== '' || prefixText !== '', 'form-field--suffix-icon': suffixIcon !== '' || suffixText !== '' || customButton, 'form-field--prefix-text': prefixText !== '', 'form-field--suffix-text': suffixText !== '', 'form-field--error': errorMessageDisplay !== '', 'form-field--log': (hint && hint.log) || (hasCharCount && maxLengthValue != null && charCount > maxLengthValue), 'form-field--disabled': disabled, 'form-field--active':content.length > 0}">
        ...
        <template>
            <input :type="type" class="form-control" :class="[altClass, {'text-right': suffixIcon !== '' || suffixText !== '', 'vertical-align': !$slots.default}]" autocomplete="off" spellcheck="false"
                :id="id"
                :name="id"
                tabindex="0"
                :title="content"
...
Vue.component('TvInputNumber', {
    ...
    methods: {
        ...
        applyMask: function(e) {
            ...
            if(this.mask[index] != '#') {
                e.target.value += this.mask[index]
            }
            else {
                return
            }
            ...
            if(this.minValue || this.maxValue) {
                ...
                if(this.maxValue && auxValue > this.maxValue) {
                    if(this.format != -1 && this.format != 0) {
                        ...
                        this.content = this.maxValue.toString();
                    }
                }
            }
